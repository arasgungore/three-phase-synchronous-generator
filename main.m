...
V_rated = 13.8e3;                   % rated line voltage in volts (V)
S_rated = 50e6;                     % rated apparent power in volt-amperes (VA)
...
title('Phasor Diagram for Rated Conditions', 'Color', 'r')
legend
axis equal
grid on

saveas(fig_handle, 'Plots/1.png','png');
...
saveas(fig_handle, 'Plots/2.png','png');
